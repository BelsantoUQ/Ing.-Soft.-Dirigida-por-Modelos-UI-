 ...
 *   <li>{@link uidiagram.impl.ModelElementImpl#getColour <em>Colour</em>}</li>
 *   <li>{@link uidiagram.impl.ModelElementImpl#getPosX <em>Pos X</em>}</li>
 *   <li>{@link uidiagram.impl.ModelElementImpl#getPosY <em>Pos Y</em>}</li>
 *   <li>{@link uidiagram.impl.ModelElementImpl#getWidth <em>Width</em>}</li>
 *   <li>{@link uidiagram.impl.ModelElementImpl#getHeigt <em>Heigt</em>}</li>
 *   <li>{@link uidiagram.impl.ModelElementImpl#getBackgroundColor <em>Background Color</em>}</li>
 *   <li>{@link uidiagram.impl.ModelElementImpl#getLongitud <em>Longitud</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ModelElementImpl extends EObjectImpl implements ModelElement {
	...
	public void setColour(String newColour) {
		...
		colour = newColour;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UidiagramPackage.MODEL_ELEMENT__COLOUR, oldColour, colour));
	}
	...
	public void setPosX(String newPosX) {
		...
		posX = newPosX;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UidiagramPackage.MODEL_ELEMENT__POS_X, oldPosX, posX));
	}
	...
	public void setPosY(String newPosY) {
		...
		posY = newPosY;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UidiagramPackage.MODEL_ELEMENT__POS_Y, oldPosY, posY));
	}
	...
	public void setHeigt(String newHeigt) {
		...
		heigt = newHeigt;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UidiagramPackage.MODEL_ELEMENT__HEIGT, oldHeigt, heigt));
	}
	...
	public void setLongitud(String newLongitud) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UidiagramPackage.MODEL_ELEMENT__LONGITUD, oldLongitud, longitud));
	}
