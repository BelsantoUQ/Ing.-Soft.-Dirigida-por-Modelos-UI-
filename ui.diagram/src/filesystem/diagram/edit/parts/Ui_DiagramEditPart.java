...
import filesystem.diagram.edit.policies.Ui_DiagramCanonicalEditPolicy;
import filesystem.diagram.edit.policies.Ui_DiagramItemSemanticEditPolicy;
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DiagramDragDropEditPolicy() {
			...
			private Command createShortcutsCommand(DropObjectsRequest dropRequest,
				...
				if (command != null) {
					return command
							.chain(new ICommandProxy(new FilesystemCreateShortcutDecorationsCommand(getEditingDomain(),
