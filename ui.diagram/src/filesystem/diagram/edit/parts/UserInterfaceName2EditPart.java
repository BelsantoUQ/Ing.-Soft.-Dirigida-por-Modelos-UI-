 ...
 * @generated
 */
public class UserInterfaceName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public UserInterfaceName2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = FilesystemParserProvider.getParser(FilesystemElementTypes.UserInterface_3004, getParserElement(),
					FilesystemVisualIDRegistry
							.getType(filesystem.diagram.edit.parts.UserInterfaceName2EditPart.VISUAL_ID));
		}
		return parser;
	}
