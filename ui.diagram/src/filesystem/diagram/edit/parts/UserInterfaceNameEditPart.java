...
public class UserInterfaceNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = FilesystemParserProvider.getParser(FilesystemElementTypes.UserInterface_2001, getParserElement(),
					FilesystemVisualIDRegistry
							.getType(filesystem.diagram.edit.parts.UserInterfaceNameEditPart.VISUAL_ID));
		}
		return parser;
	}
