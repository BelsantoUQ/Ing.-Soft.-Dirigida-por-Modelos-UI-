...
import filesystem.diagram.edit.policies.ButtonItemSemanticEditPolicy;
...
public class ButtonEditPart extends ShapeNodeEditPart {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(FilesystemVisualIDRegistry.getType(ButtonNameEditPart.VISUAL_ID));
	}
