...
public class ButtonNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = FilesystemParserProvider.getParser(FilesystemElementTypes.Button_3002, getParserElement(),
					FilesystemVisualIDRegistry.getType(filesystem.diagram.edit.parts.ButtonNameEditPart.VISUAL_ID));
		}
		return parser;
	}
