...
import filesystem.diagram.edit.policies.LabelItemSemanticEditPolicy;
...
public class LabelEditPart extends ShapeNodeEditPart {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(FilesystemVisualIDRegistry.getType(LabelNameEditPart.VISUAL_ID));
	}
