...
public class LabelNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = FilesystemParserProvider.getParser(FilesystemElementTypes.Label_3001, getParserElement(),
					FilesystemVisualIDRegistry.getType(filesystem.diagram.edit.parts.LabelNameEditPart.VISUAL_ID));
		}
		return parser;
	}
