 ...
 * @generated
 */
public class Ui_DiagramCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return FilesystemPackage.eINSTANCE.getUi_Diagram_Drives();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<FilesystemNodeDescriptor> childDescriptors = FilesystemDiagramUpdater
				.getUi_Diagram_1000SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return UserInterfaceEditPart.VISUAL_ID == FilesystemVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<FilesystemNodeDescriptor> childDescriptors = FilesystemDiagramUpdater
				.getUi_Diagram_1000SemanticChildren((View) getHost().getModel());
