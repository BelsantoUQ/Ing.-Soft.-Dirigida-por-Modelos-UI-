 ...
 * @generated
 */
public class UserInterfaceUserInterfaceLsWidgetsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<FilesystemNodeDescriptor> childDescriptors = FilesystemDiagramUpdater
				.getUserInterfaceUserInterfaceLsWidgetsCompartment_7001SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<FilesystemNodeDescriptor> childDescriptors = FilesystemDiagramUpdater
				.getUserInterfaceUserInterfaceLsWidgetsCompartment_7001SemanticChildren((View) getHost().getModel());
