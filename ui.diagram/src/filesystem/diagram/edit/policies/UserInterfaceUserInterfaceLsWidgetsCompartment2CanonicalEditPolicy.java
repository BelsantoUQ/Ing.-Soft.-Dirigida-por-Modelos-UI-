 ...
 * @generated
 */
public class UserInterfaceUserInterfaceLsWidgetsCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return FilesystemPackage.eINSTANCE.getUserInterface_LsWidgets();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<FilesystemNodeDescriptor> childDescriptors = FilesystemDiagramUpdater
				.getUserInterfaceUserInterfaceLsWidgetsCompartment_7002SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<FilesystemNodeDescriptor> childDescriptors = FilesystemDiagramUpdater
				.getUserInterfaceUserInterfaceLsWidgetsCompartment_7002SemanticChildren((View) getHost().getModel());
