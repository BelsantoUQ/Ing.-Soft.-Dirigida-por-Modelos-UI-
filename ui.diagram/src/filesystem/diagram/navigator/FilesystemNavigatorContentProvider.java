...
public class FilesystemNavigatorContentProvider implements ICommonContentProvider {
	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case Ui_DiagramEditPart.VISUAL_ID: {
			...
			connectedViews = getChildrenByType(Collections.singleton(sv),
					FilesystemVisualIDRegistry.getType(UserInterfaceEditPart.VISUAL_ID));
		...
		case UserInterfaceEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			Collection<View> connectedViews;
			connectedViews = getChildrenByType(Collections.singleton(sv), FilesystemVisualIDRegistry
					.getType(UserInterfaceUserInterfaceLsWidgetsCompartmentEditPart.VISUAL_ID));
			connectedViews = getChildrenByType(connectedViews,
					FilesystemVisualIDRegistry.getType(LabelEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
			connectedViews = getChildrenByType(Collections.singleton(sv), FilesystemVisualIDRegistry
					.getType(UserInterfaceUserInterfaceLsWidgetsCompartmentEditPart.VISUAL_ID));
			connectedViews = getChildrenByType(connectedViews,
					FilesystemVisualIDRegistry.getType(ButtonEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
			connectedViews = getChildrenByType(Collections.singleton(sv), FilesystemVisualIDRegistry
					.getType(UserInterfaceUserInterfaceLsWidgetsCompartmentEditPart.VISUAL_ID));
			connectedViews = getChildrenByType(connectedViews,
					FilesystemVisualIDRegistry.getType(TextInputEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
			connectedViews = getChildrenByType(Collections.singleton(sv), FilesystemVisualIDRegistry
					.getType(UserInterfaceUserInterfaceLsWidgetsCompartmentEditPart.VISUAL_ID));
			connectedViews = getChildrenByType(connectedViews,
					FilesystemVisualIDRegistry.getType(UserInterface2EditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
			return result.toArray();
		}
		...
		case UserInterface2EditPart.VISUAL_ID: {
			...
			Collection<View> connectedViews;
			connectedViews = getChildrenByType(Collections.singleton(sv), FilesystemVisualIDRegistry
					.getType(UserInterfaceUserInterfaceLsWidgetsCompartment2EditPart.VISUAL_ID));
			connectedViews = getChildrenByType(connectedViews,
					FilesystemVisualIDRegistry.getType(LabelEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
			connectedViews = getChildrenByType(Collections.singleton(sv), FilesystemVisualIDRegistry
	...
	*/
	 ...
	 * @generated
	 */
	private Collection<FilesystemNavigatorItem> getForeignShortcuts(Diagram diagram, Object parent) {
		LinkedList<View> result = new LinkedList<View>();
