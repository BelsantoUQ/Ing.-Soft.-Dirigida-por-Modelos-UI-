 ...
 * @generated
 */
public class MenuBarMenuBarLstWidgetsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getMenuBarMenuBarLstWidgetsCompartment_7007SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getMenuBarMenuBarLstWidgetsCompartment_7007SemanticChildren((View) getHost().getModel());
