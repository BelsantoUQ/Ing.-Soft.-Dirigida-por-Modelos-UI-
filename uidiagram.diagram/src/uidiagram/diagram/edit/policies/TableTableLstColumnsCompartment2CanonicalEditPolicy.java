 ...
 * @generated
 */
public class TableTableLstColumnsCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return UidiagramPackage.eINSTANCE.getTable_LstColumns();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getTableTableLstColumnsCompartment_7015SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return Column2EditPart.VISUAL_ID == UidiagramVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getTableTableLstColumnsCompartment_7015SemanticChildren((View) getHost().getModel());
