 ...
 * @generated
 */
public class ColumnColumnLstWidgetsCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getColumnColumnLstWidgetsCompartment_7011SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getColumnColumnLstWidgetsCompartment_7011SemanticChildren((View) getHost().getModel());
