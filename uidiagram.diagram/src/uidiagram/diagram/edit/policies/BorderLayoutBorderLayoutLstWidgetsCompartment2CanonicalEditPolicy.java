 ...
 * @generated
 */
public class BorderLayoutBorderLayoutLstWidgetsCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return UidiagramPackage.eINSTANCE.getGraphicalContainer_LstWidgets();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getBorderLayoutBorderLayoutLstWidgetsCompartment_7013SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getBorderLayoutBorderLayoutLstWidgetsCompartment_7013SemanticChildren((View) getHost().getModel());
