 ...
 * @generated
 */
public class MenuBarMenuBarLstWidgetsCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getMenuBarMenuBarLstWidgetsCompartment_7012SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getMenuBarMenuBarLstWidgetsCompartment_7012SemanticChildren((View) getHost().getModel());
