 ...
 * @generated
 */
public class GroupGroupLstWidgetsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getGroupGroupLstWidgetsCompartment_7004SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getGroupGroupLstWidgetsCompartment_7004SemanticChildren((View) getHost().getModel());
