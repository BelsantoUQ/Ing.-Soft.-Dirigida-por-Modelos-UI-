 ...
 * @generated
 */
public class BorderLayoutBorderLayoutLstWidgetsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getBorderLayoutBorderLayoutLstWidgetsCompartment_7008SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getBorderLayoutBorderLayoutLstWidgetsCompartment_7008SemanticChildren((View) getHost().getModel());
