 ...
 * @generated
 */
public class GroupGroupLstWidgetsCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getGroupGroupLstWidgetsCompartment_7009SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getGroupGroupLstWidgetsCompartment_7009SemanticChildren((View) getHost().getModel());
