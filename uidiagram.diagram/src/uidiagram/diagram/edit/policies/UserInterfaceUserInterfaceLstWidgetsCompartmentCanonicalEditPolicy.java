 ...
 * @generated
 */
public class UserInterfaceUserInterfaceLstWidgetsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return UidiagramPackage.eINSTANCE.getUserInterface_LstWidgets();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getUserInterfaceUserInterfaceLstWidgetsCompartment_7001SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getUserInterfaceUserInterfaceLstWidgetsCompartment_7001SemanticChildren((View) getHost().getModel());
