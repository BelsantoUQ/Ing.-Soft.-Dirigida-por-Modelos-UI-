...
import uidiagram.diagram.edit.policies.ColumnColumnLstWidgetsCompartment2CanonicalEditPolicy;
import uidiagram.diagram.edit.policies.ColumnColumnLstWidgetsCompartment2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ColumnColumnLstWidgetsCompartment2EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public ColumnColumnLstWidgetsCompartment2EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.ColumnColumnLstWidgetsCompartment2EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ColumnColumnLstWidgetsCompartment2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(UidiagramVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new ColumnColumnLstWidgetsCompartment2CanonicalEditPolicy());
	}
