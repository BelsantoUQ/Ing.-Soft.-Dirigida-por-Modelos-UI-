...
import uidiagram.diagram.edit.policies.MenuBarMenuBarLstWidgetsCompartmentCanonicalEditPolicy;
import uidiagram.diagram.edit.policies.MenuBarMenuBarLstWidgetsCompartmentItemSemanticEditPolicy;
 ...
 * @generated
 */
public class MenuBarMenuBarLstWidgetsCompartmentEditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public MenuBarMenuBarLstWidgetsCompartmentEditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.MenuBarMenuBarLstWidgetsCompartmentEditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new MenuBarMenuBarLstWidgetsCompartmentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(UidiagramVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new MenuBarMenuBarLstWidgetsCompartmentCanonicalEditPolicy());
	}
