...
public class UserInterfaceEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof UserInterfaceUserInterfaceLstWidgetsCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getUserInterfaceLstWidgetsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((UserInterfaceUserInterfaceLstWidgetsCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof UserInterfaceUserInterfaceLstWidgetsCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getUserInterfaceLstWidgetsCompartmentFigure();
			pane.remove(((UserInterfaceUserInterfaceLstWidgetsCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof UserInterfaceUserInterfaceLstWidgetsCompartmentEditPart) {
			return getPrimaryShape().getUserInterfaceLstWidgetsCompartmentFigure();
		}
	...
	*/
	...
	public class UserInterfaceFigure extends RoundedRectangle {
		 ...
		 * @generated
		 */
		private RectangleFigure fUserInterfaceLstWidgetsCompartmentFigure;
		...
		private void createContents() {
			...
			fUserInterfaceLstWidgetsCompartmentFigure = new RectangleFigure();

			fUserInterfaceLstWidgetsCompartmentFigure.setOutline(false);

			this.add(fUserInterfaceLstWidgetsCompartmentFigure);
		 ...
		 * @generated
		 */
		public RectangleFigure getUserInterfaceLstWidgetsCompartmentFigure() {
			return fUserInterfaceLstWidgetsCompartmentFigure;
		}
