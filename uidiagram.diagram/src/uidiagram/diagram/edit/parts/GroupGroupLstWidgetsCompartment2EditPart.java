...
import uidiagram.diagram.edit.policies.GroupGroupLstWidgetsCompartment2CanonicalEditPolicy;
import uidiagram.diagram.edit.policies.GroupGroupLstWidgetsCompartment2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class GroupGroupLstWidgetsCompartment2EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public GroupGroupLstWidgetsCompartment2EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.GroupGroupLstWidgetsCompartment2EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new GroupGroupLstWidgetsCompartment2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(UidiagramVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new GroupGroupLstWidgetsCompartment2CanonicalEditPolicy());
	}
