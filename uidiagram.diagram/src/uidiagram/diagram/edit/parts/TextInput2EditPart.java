...
import uidiagram.diagram.edit.policies.TextInput2ItemSemanticEditPolicy;
...
public class TextInput2EditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new TextInput2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TextInputName2EditPart) {
			((TextInputName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureTextInputLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(TextInputName2EditPart.VISUAL_ID));
	}
