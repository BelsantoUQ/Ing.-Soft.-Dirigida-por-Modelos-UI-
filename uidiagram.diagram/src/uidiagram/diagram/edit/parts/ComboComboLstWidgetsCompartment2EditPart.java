...
import uidiagram.diagram.edit.policies.ComboComboLstWidgetsCompartment2CanonicalEditPolicy;
import uidiagram.diagram.edit.policies.ComboComboLstWidgetsCompartment2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ComboComboLstWidgetsCompartment2EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public ComboComboLstWidgetsCompartment2EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.ComboComboLstWidgetsCompartment2EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ComboComboLstWidgetsCompartment2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(UidiagramVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new ComboComboLstWidgetsCompartment2CanonicalEditPolicy());
	}
