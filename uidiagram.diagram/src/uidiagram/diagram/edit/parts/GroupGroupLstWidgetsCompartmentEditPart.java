...
import uidiagram.diagram.edit.policies.GroupGroupLstWidgetsCompartmentCanonicalEditPolicy;
import uidiagram.diagram.edit.policies.GroupGroupLstWidgetsCompartmentItemSemanticEditPolicy;
 ...
 * @generated
 */
public class GroupGroupLstWidgetsCompartmentEditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public GroupGroupLstWidgetsCompartmentEditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.GroupGroupLstWidgetsCompartmentEditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new GroupGroupLstWidgetsCompartmentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(UidiagramVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new GroupGroupLstWidgetsCompartmentCanonicalEditPolicy());
	}
