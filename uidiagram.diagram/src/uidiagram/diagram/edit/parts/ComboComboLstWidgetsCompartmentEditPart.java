...
import uidiagram.diagram.edit.policies.ComboComboLstWidgetsCompartmentCanonicalEditPolicy;
import uidiagram.diagram.edit.policies.ComboComboLstWidgetsCompartmentItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ComboComboLstWidgetsCompartmentEditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public ComboComboLstWidgetsCompartmentEditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.ComboComboLstWidgetsCompartmentEditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ComboComboLstWidgetsCompartmentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(UidiagramVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new ComboComboLstWidgetsCompartmentCanonicalEditPolicy());
	}
