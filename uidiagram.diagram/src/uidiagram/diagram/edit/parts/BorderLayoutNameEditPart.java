 ...
 * @generated
 */
public class BorderLayoutNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public BorderLayoutNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UidiagramParserProvider.getParser(UidiagramElementTypes.BorderLayout_3014, getParserElement(),
					UidiagramVisualIDRegistry.getType(uidiagram.diagram.edit.parts.BorderLayoutNameEditPart.VISUAL_ID));
		}
		return parser;
	}
