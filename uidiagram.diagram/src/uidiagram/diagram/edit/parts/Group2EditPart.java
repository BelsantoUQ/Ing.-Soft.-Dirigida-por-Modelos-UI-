...
import uidiagram.diagram.edit.policies.Group2ItemSemanticEditPolicy;
...
public class Group2EditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof GroupGroupLstWidgetsCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getGroupLstWidgetsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((GroupGroupLstWidgetsCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof GroupGroupLstWidgetsCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getGroupLstWidgetsCompartmentFigure();
			pane.remove(((GroupGroupLstWidgetsCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof GroupGroupLstWidgetsCompartment2EditPart) {
			return getPrimaryShape().getGroupLstWidgetsCompartmentFigure();
		}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(GroupName2EditPart.VISUAL_ID));
	}
	...
	public class GroupFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private RectangleFigure fGroupLstWidgetsCompartmentFigure;
		...
		private void createContents() {
			...
			fGroupLstWidgetsCompartmentFigure = new RectangleFigure();

			fGroupLstWidgetsCompartmentFigure.setOutline(false);

			this.add(fGroupLstWidgetsCompartmentFigure);
		 ...
		 * @generated
		 */
		public RectangleFigure getGroupLstWidgetsCompartmentFigure() {
			return fGroupLstWidgetsCompartmentFigure;
		}
