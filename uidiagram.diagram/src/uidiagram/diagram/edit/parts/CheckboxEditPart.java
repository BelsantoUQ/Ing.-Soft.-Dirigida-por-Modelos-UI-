...
import uidiagram.diagram.edit.policies.CheckboxItemSemanticEditPolicy;
...
public class CheckboxEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CheckboxNameEditPart) {
			((CheckboxNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureCheckboxLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(CheckboxNameEditPart.VISUAL_ID));
	}
