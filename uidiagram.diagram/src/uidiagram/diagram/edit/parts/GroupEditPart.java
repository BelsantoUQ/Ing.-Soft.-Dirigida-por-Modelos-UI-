...
public class GroupEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof GroupGroupLstWidgetsCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getGroupLstWidgetsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((GroupGroupLstWidgetsCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof GroupGroupLstWidgetsCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getGroupLstWidgetsCompartmentFigure();
			pane.remove(((GroupGroupLstWidgetsCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof GroupGroupLstWidgetsCompartmentEditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(GroupNameEditPart.VISUAL_ID));
	}
