...
import uidiagram.diagram.edit.policies.BorderLayoutBorderLayoutLstWidgetsCompartmentCanonicalEditPolicy;
import uidiagram.diagram.edit.policies.BorderLayoutBorderLayoutLstWidgetsCompartmentItemSemanticEditPolicy;
 ...
 * @generated
 */
public class BorderLayoutBorderLayoutLstWidgetsCompartmentEditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public BorderLayoutBorderLayoutLstWidgetsCompartmentEditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.BorderLayoutBorderLayoutLstWidgetsCompartmentEditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new BorderLayoutBorderLayoutLstWidgetsCompartmentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(UidiagramVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new BorderLayoutBorderLayoutLstWidgetsCompartmentCanonicalEditPolicy());
	}
