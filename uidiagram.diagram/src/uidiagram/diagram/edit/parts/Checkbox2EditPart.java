...
public class Checkbox2EditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CheckboxName2EditPart) {
			((CheckboxName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureCheckboxLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(CheckboxName2EditPart.VISUAL_ID));
	}
