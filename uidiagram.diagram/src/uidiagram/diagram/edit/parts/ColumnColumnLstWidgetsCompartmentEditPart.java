...
import uidiagram.diagram.edit.policies.ColumnColumnLstWidgetsCompartmentCanonicalEditPolicy;
import uidiagram.diagram.edit.policies.ColumnColumnLstWidgetsCompartmentItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ColumnColumnLstWidgetsCompartmentEditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public ColumnColumnLstWidgetsCompartmentEditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.ColumnColumnLstWidgetsCompartmentEditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ColumnColumnLstWidgetsCompartmentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(UidiagramVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new ColumnColumnLstWidgetsCompartmentCanonicalEditPolicy());
	}
