...
import uidiagram.diagram.edit.policies.MenuBarMenuBarLstWidgetsCompartment2CanonicalEditPolicy;
import uidiagram.diagram.edit.policies.MenuBarMenuBarLstWidgetsCompartment2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class MenuBarMenuBarLstWidgetsCompartment2EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public MenuBarMenuBarLstWidgetsCompartment2EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.MenuBarMenuBarLstWidgetsCompartment2EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new MenuBarMenuBarLstWidgetsCompartment2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(UidiagramVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new MenuBarMenuBarLstWidgetsCompartment2CanonicalEditPolicy());
	}
