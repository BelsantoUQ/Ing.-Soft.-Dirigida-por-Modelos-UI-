...
import uidiagram.diagram.edit.policies.BorderLayoutBorderLayoutLstWidgetsCompartment2CanonicalEditPolicy;
import uidiagram.diagram.edit.policies.BorderLayoutBorderLayoutLstWidgetsCompartment2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class BorderLayoutBorderLayoutLstWidgetsCompartment2EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public BorderLayoutBorderLayoutLstWidgetsCompartment2EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.BorderLayoutBorderLayoutLstWidgetsCompartment2EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new BorderLayoutBorderLayoutLstWidgetsCompartment2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(UidiagramVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new BorderLayoutBorderLayoutLstWidgetsCompartment2CanonicalEditPolicy());
	}
