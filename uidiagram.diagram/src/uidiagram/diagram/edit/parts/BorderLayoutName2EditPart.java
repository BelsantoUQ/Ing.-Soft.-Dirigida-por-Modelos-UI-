 ...
 * @generated
 */
public class BorderLayoutName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public BorderLayoutName2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UidiagramParserProvider.getParser(UidiagramElementTypes.BorderLayout_3026, getParserElement(),
					UidiagramVisualIDRegistry
							.getType(uidiagram.diagram.edit.parts.BorderLayoutName2EditPart.VISUAL_ID));
		}
		return parser;
	}
