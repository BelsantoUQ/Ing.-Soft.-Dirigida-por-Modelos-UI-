...
import uidiagram.diagram.edit.policies.TableTableLstWidgetsCompartment2CanonicalEditPolicy;
import uidiagram.diagram.edit.policies.TableTableLstWidgetsCompartment2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class TableTableLstWidgetsCompartment2EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public TableTableLstWidgetsCompartment2EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.TableTableLstWidgetsCompartment2EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new TableTableLstWidgetsCompartment2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(UidiagramVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new TableTableLstWidgetsCompartment2CanonicalEditPolicy());
	}
