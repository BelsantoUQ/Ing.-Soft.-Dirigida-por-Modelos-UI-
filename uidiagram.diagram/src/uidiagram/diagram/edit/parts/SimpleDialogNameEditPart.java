 ...
 * @generated
 */
public class SimpleDialogNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public SimpleDialogNameEditPart(View view) {
		super(view);
	}
	...
	*/
	protected Image getLabelIcon() {
		...
		return UidiagramElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UidiagramParserProvider.getParser(UidiagramElementTypes.SimpleDialog_3021, getParserElement(),
					UidiagramVisualIDRegistry.getType(uidiagram.diagram.edit.parts.SimpleDialogNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, UidiagramEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
