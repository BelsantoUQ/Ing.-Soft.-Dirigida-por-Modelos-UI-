...
/**
 * This is the item provider adapter for a {@link filesystem.UserInterface} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UserInterfaceItemProvider extends ModelElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FilesystemPackage.Literals.USER_INTERFACE__TITLE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FilesystemPackage.Literals.USER_INTERFACE__LS_WIDGETS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FilesystemPackage.Literals.USER_INTERFACE__LS_WIDGETS,
				 FilesystemFactory.eINSTANCE.createModelElement()));

		newChildDescriptors.add
			(createChildParameter
				(FilesystemPackage.Literals.USER_INTERFACE__LS_WIDGETS,
				 FilesystemFactory.eINSTANCE.createUserInterface()));

		newChildDescriptors.add
			(createChildParameter
				(FilesystemPackage.Literals.USER_INTERFACE__LS_WIDGETS,
				 FilesystemFactory.eINSTANCE.createGraphicalContainer()));

		newChildDescriptors.add
			(createChildParameter
				(FilesystemPackage.Literals.USER_INTERFACE__LS_WIDGETS,
				 FilesystemFactory.eINSTANCE.createIndividualContainer()));

		newChildDescriptors.add
			(createChildParameter
				(FilesystemPackage.Literals.USER_INTERFACE__LS_WIDGETS,
				 FilesystemFactory.eINSTANCE.createLabel()));

		newChildDescriptors.add
			(createChildParameter
				(FilesystemPackage.Literals.USER_INTERFACE__LS_WIDGETS,
				 FilesystemFactory.eINSTANCE.createButton()));

		newChildDescriptors.add
			(createChildParameter
				(FilesystemPackage.Literals.USER_INTERFACE__LS_WIDGETS,
				 FilesystemFactory.eINSTANCE.createTextInput()));
	}
